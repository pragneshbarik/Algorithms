...
int main()
{
    /*
    Advantages:
        * Unordered Maps use hash tables, generally have better time complexity.
        * All operations take O(1) time.
        * Useful when order of elements doesn't matter.

    Drawbacks:
        * Can only be used for simple data types only.
        * Cannot be used for containers or complex data types.
        * unordered_map<pair<int, int>> is invalid, with throw a compilation error.
